...
file = open(folder_path+"/text_files/bestThreshold.txt", 'r')
lines = file.readlines()
_, ep, _, adcf, _, threshold = lines[0].split(' ')
...
plt.ylabel('a-DCF')
plt.title('a-DCF values concerning optimized threshold in development')
plt.legend()
...
plt.xlabel('Threshold')
plt.ylabel('a-DCF')
plt.title('a-DCF values concerning optimized threshold in evaluation')
plt.legend()
